...
$roots_includes = array(
  ...
  'lib/aq_resizer.php',           // Utility functions
  ...
  'framework/post.options.php',          // Custom functions
  'lib/pagination.php',          // Pagination functions
  'lib/widget/manufacter_widget.php',          // Pagination functions
);
