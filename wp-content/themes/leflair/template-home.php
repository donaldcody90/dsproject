	...
	<section>
		...
		<div ng-class="{
			...
			<a class="image-link" href="category/sales/" signup-link="">
				<img class="fluid category-hero ng-scope ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e2102b213fb40f00ee4185.jpg'); ?>" >
			</a>
		...
		<item class="col-md-6 col-xs-12 section-item ng-scope ng-hide" ng-repeat="sale in salesList" ng-show="($index !== 0) || ($index === 0 &amp;&amp; $breakpoint.availUntil(featuredAvailAt))">
			<a href="category/sales/" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e21030213fb40f00ee4186.jpg'); ?>" >
				<div class="caption">
					<h3 class="ng-binding">
						Drap Giường Novelle
		...
		<item class="col-md-6 col-xs-12 section-item ng-scope" ng-repeat="sale in salesList" ng-show="($index !== 0) || ($index === 0 &amp;&amp; $breakpoint.availUntil(featuredAvailAt))">
			<a href="/products/xit-khu-mui-toan-than-si-lolita-lempicka-57e241a9eb696d0f00a72f31" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e35e779773a7100095cbd8.jpg'); ?>" >
				<div class="caption">
					<h3 class="ng-binding">
		...
		<item class="col-md-6 col-xs-12 section-item ng-scope" ng-repeat="sale in salesList" ng-show="($index !== 0) || ($index === 0 &amp;&amp; $breakpoint.availUntil(featuredAvailAt))">
			<a href="category/sales/" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57dfb7ffc745c410009ea181.jpg'); ?>" >
				<div class="caption">
					<h3 class="ng-binding">
		...
		<item class="col-md-6 col-xs-12 section-item ng-scope" ng-repeat="sale in salesList" ng-show="($index !== 0) || ($index === 0 &amp;&amp; $breakpoint.availUntil(featuredAvailAt))">
			<a href="category/sales/" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57df9e7d212ef90f006828e7.jpg'); ?>" >
				<div class="caption">
					<h3 class="ng-binding">
		...
		<item class="col-md-6 col-xs-12 section-item ng-scope" ng-repeat="sale in salesList" ng-show="($index !== 0) || ($index === 0 &amp;&amp; $breakpoint.availUntil(featuredAvailAt))">
			<a href="category/sales/" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57df9e19212ef90f006828d8.jpg'); ?>" data-rio-width="555" data-rio-img="https://leflair-assets.storage.googleapis.com/57df9e19212ef90f006828d8.jpg">
				<div class="caption">
					<h3 class="ng-binding">
		...
		<img class="fluid ng-isolate-scope" src="<?php echo get_theme_option('home_banner', 'url'); ?>" data-rio-width="1140" data-rio-img="https://leflair-assets.storage.googleapis.com/57e1fa80213fb40f00ee3f73.jpg">
		</a></div><!-- end ngRepeat: sale in salesList -->
		<item class="col-md-6 col-xs-12 section-item ng-scope" ng-repeat="sale in salesList" ng-show="($index !== 0) || ($index === 0 &amp;&amp; $breakpoint.availUntil(featuredAvailAt))">
			<a href="category/sales/" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e3bcb157b5f40f00130daf.jpg'); ?>" data-rio-width="555" data-rio-img="https://leflair-assets.storage.googleapis.com/57e3bcb157b5f40f00130daf.jpg">
				<div class="caption">
					<h3 class="ng-binding">
			...
			<a href="category/sales/" signup-link="">
				<img class="fluid ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e109ca52b3930f00aefe41.jpg');?>" data-rio-width="555" data-rio-img="https://leflair-assets.storage.googleapis.com/57e109ca52b3930f00aefe41.jpg">
				<div class="caption">
					<h3 class="ng-binding">
		...
		<innerbox style="width: 4560px;">
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/bo-drap-giuong-petals-160x200-5-mon-574f51d9ab6f5d0e0038c5ef?Color=ESTELLA" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e3c2a257b5f40f00130f34.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57e3c2a257b5f40f00130f34.jpg">
					<div class="content">
						<p class="brand ng-binding">Novelle</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/giay-bet-nu-d-rhosyn-b-57749ec7eda13b0e00489562?Color=DOVE%20GREY" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/5774bacb21acf30e0032082c.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/5774bacb21acf30e0032082c.jpg">
					<div class="content">
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/bo-drap-giuong-cruise-160x200-6-mon-574f51d9ab6f5d0e0038c5ea?Color=SCOTTISH" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e3836b02339410006e5856.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57e3836b02339410006e5856.jpg">
					<div class="content">
						<p class="brand ng-binding">Novelle</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/bo-drap-giuong-petals-180x200-5-mon-574f51d9ab6f5d0e0038c5f0?Color=LINNEA" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e3c30a57b5f40f00130f37.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57e3c30a57b5f40f00130f37.jpg">
					<div class="content">
						<p class="brand ng-binding">Novelle</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/bo-drap-giuong-idol-180x200-cm-5-mon-574f51d9ab6f5d0e0038c5df?Color=LOZENRO" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/5751538ea816261100b5878c.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/5751538ea816261100b5878c.jpg">
					<div class="content">
						<p class="brand ng-binding">Novelle</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/bo-drap-chan-drap-giuong-harumi-160200-5-mon-57ada47ece398a0f0043c743?Color=DR-2356" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e3c3cb57b5f40f00130f43.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57e3c3cb57b5f40f00130f43.jpg">
					<div class="content">
						<p class="brand ng-binding">Novelle</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/bo-drap-giuong-cruise-180x200-cm-574f51d9ab6f5d0e0038c5e9?Color=EMONA" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57515328a816261100b58788.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57515328a816261100b58788.jpg">
					<div class="content">
						<p class="brand ng-binding">Novelle</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/giay-sneaker--nu-new-club-a-57749ec7eda13b0e00489552?Color=DOVE%20GREY" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57e381c202339410006e5811.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57e381c202339410006e5811.jpg">
					<div class="content">
						<p class="brand ng-binding">Geox</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/giay-lupe-cho-nu-5684ea04504cc11000765a29?Color=BLACK%2FNATURAL" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/5774a65c6d45cc0e00af20c9.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/5774a65c6d45cc0e00af20c9.jpg">
					<div class="content">
						<p class="brand ng-binding">Geox</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/giay-de-bet-nu-lola-mau-nau-be-5684ea04504cc11000765a33?Color=LIGHT%20TAUPE" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/568c9fd01cdc210e00eaef11.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/568c9fd01cdc210e00eaef11.jpg">
					<div class="content">
						<p class="brand ng-binding">Geox</p>
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/tui-deo-cheo-nu-hai-tong-mau-57db7ac29632650f006afab5?Color=ORANGE%20MIXED%20BLACK" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57dbfb6ee4dc4612000063be.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57dbfb6ee4dc4612000063be.jpg">
					<div class="content">
			...
			<item ng-repeat="product in products" class="ng-scope" style="width: 285px;">
				<a href="/products/tui-deo-cheo-nu-mau-cam-57db7ac29632650f006afab7?Color=ORANGE" signup-link="">
					<img trigger="triggerReload" class="ng-isolate-scope" src="<?php echo site_url('wp-content/themes/leflair/assets/img/57dbfba6e4dc4612000063c5.jpg');?>" data-rio-width="271" data-rio-img="https://leflair-assets.storage.googleapis.com/57dbfba6e4dc4612000063c5.jpg">
					<div class="content">
						<p class="brand ng-binding">NEYUH</p>
