						...
						<div class="row">
							<div class="col-md-12 account-nav-row">
								<ul class="list-inline account-nav">
									<li class="active"><a href="/account">Thông tin tài khoản</a></li>
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div>
									...
									<div>
										...
										<p><a class="underline-link edit_account_info">Sửa thông tin</a></p>
									</div>

									<!-- Account Information: Edit Mode -->
									<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
										<div class="row ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-min ng-valid-max ng-valid-pattern ng-hide">
											...
											<div class="col-xs-12 form-group">
												<div class="row">
													...
													<div class="col-md-6 form-group">
															...
															<div class="ui-select-container ui-select-bootstrap dropdown ng-valid" name="gender">
																<div class="ui-select-match">
																	<span tabindex="-1" class="btn btn-default form-control ui-select-toggle" style="outline: 0;">
																	<span class="ui-select-placeholder text-muted ng-binding"></span> <span class="ui-select-match-text pull-left ng-hide"><span class="ng-binding ng-scope"></span></span> <i class="caret pull-right"></i> <a style="margin-right: 10px" class="btn btn-xs btn-link pull-right ng-hide">
																...
																<ul class="ui-select-choices ui-select-choices-content ui-select-dropdown dropdown-menu ng-scope">
																	<li class="ui-select-choices-group" id="ui-select-choices-0">
																		...
																		<!-- ngRepeat: gender in $select.items --><!-- ngIf: $select.open -->
											...
											<div class="col-xs-12 form-group">
												...
												<button class="btn btn-default btn-lg">Trở lại</button>
											</div>
										</div>
									</form>
								</h4></div>
								...
								<?php foreach ( $get_addresses as $name => $title ) : ?>
									<div class="col-md-6">
		                                ...
		                                <p><a class="underline-link <?php echo 'edit'.$title; ?>">Sửa thông tin</a></p>
									</div>
									<?php endforeach; ?>
								</div>
								...
								<div class="row ng-scope">
		                            <div class="col-md-offset-2 col-md-8">
		                                <h4>
											...
											<div class="ng-scope">Điền địa chỉ giao hàng</div>
											<!-- end ngSwitchWhen: -->
											...
											<div class="col-xs-12">
												...
												<div class="row">
													...
													<div class="col-sm-6 form-group">
														...
														<p class="text text-danger ng-hide" ng-show="updateForm.district.$invalid &amp;&amp; (!updateForm.district.$pristine || isSubmitted)">Thông tin Quận/Huyện bắt buộc</p>
													</div>
													<div class="form-group"></div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<button class="btn btn-default btn-lg btn-uppercase" type="button">Trở lại</button>
								...
								<div class="row ng-scope">
		                            <div class="col-md-offset-2 col-md-8">
		                                <h4>
		                                    <!-- ngSwitchWhen: shipping -->
											<div class="ng-scope">Điền địa chỉ trên hoá đơn</div>
											<!-- end ngSwitchWhen: -->
		                                    <!-- ngSwitchWhen: billing -->
		                                </h4>
									<ui-address-form class="ng-isolate-scope">
								...
								<div>
									...
									<p>
										<a class="underline-link">Nạp thẻ quà tặng</a>
									</p>
								</div>
								<div class="row">
								...
								<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
									<div class="">
										<h3>Mật khẩu</h3>
										<p>
											<button class="btn btn-primary btn-java btn-fluid-mobile" type="button">Thay mật khẩu</button>
										</p>
